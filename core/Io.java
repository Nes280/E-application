...
public class Io {
    ...
    public void newFile( int type ) throws IOException {
        ...
        if ( type == 1 )// node
        {
            ...
            FileWriter fw2 = new FileWriter( "./node/node" + numFic + ".sql", true );
        ...
        if ( type == 2 )// bridge
        {
            ...
            FileWriter fw3 = new FileWriter( "./bridge/bridge" + numFic + ".sql", true );
        ...
        try {
            ...
            while ( ( dumpLine = brDump.readLine() ) != null ) {
                if ( dumpLine.startsWith( RID ) ) { // si on lis une arete
                    ...
                    fichierSortie3.print( "INSERT INTO `aretes`(`id`, `mot1`, `mot2`, `poids`) VALUES (\""
                            + liste.get( 0 ) + "\",\"" + liste.get( 1 ) + "\",\"" + liste.get( 2 ) + "\",\""
                            + liste.get( 3 ) + "\");\n" );
                    liste.clear();
                    ...
                    // le fichier node.csv
                    fichierSortie2.print( "INSERT INTO `noeuds`(`id`, `mot`, `type`, `poids`) VALUES (\""
                            + liste.get( 0 ) + "\",\"" + liste.get( 1 ) + "\",\"" + liste.get( 2 ) + "\",\""
                            + liste.get( 3 ) + "\");\n" );
                    ...
                    if ( liste.size() < 4 ) {
                        fichierSortie1.print( "INSERT INTO `relations`(`id`, `nomc`, `noml`, `description`) VALUES (\""
                                + liste.get( 0 ) + "\",\"" + liste.get( 1 ) + "\",\"" + liste.get( 2 ) + "\"," + "\"\""
                                + ");\n" );
                        liste.clear();
                    } else {
